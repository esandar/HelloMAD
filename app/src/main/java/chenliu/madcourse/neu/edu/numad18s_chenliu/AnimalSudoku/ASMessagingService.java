...
import chenliu.madcourse.neu.edu.numad18s_chenliu.MainActivity;
import chenliu.madcourse.neu.edu.numad18s_chenliu.R;

public class ASMessagingService extends FirebaseMessagingService {
    private static final String TAG = ASMessagingService.class.getSimpleName();
