...
public class AS_ScrollingView extends View {
    private Drawable mBackground;
    private int mScrollPos;

    public AS_ScrollingView(Context context) {
        super(context);
        init(null, 0);
    }

    public AS_ScrollingView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public AS_ScrollingView(Context context, AttributeSet attrs, int defStyle) {
