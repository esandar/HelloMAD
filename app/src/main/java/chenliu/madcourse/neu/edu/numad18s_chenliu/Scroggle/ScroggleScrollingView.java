...
public class ScroggleScrollingView extends View {
    private Drawable mBackground;
    private int mScrollPos;

    public ScroggleScrollingView(Context context) {
        super(context);
        init(null, 0);
    }

    public ScroggleScrollingView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public ScroggleScrollingView(Context context, AttributeSet attrs, int defStyle) {
